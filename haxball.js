...
const roomName = "🏆 Futsal x3 | wixent testeando google cloud 🏆";
const botName = "Bot :V";
const maxPlayers = 24;
const roomPublic = true;
const geo = [{"code": "cl", "lat": -33.4, "lon": -70.6}];
