...
//              0.7 [!fah] Ejecuta el mapa oficial futsal x4 by FAH
...
//              0.11 [!camisetasx3] Muestra las camisetas de x3.
//              0.12 [!camisetasx4] Muestra las camisetas de x4.
//              0.13 [!camisetasx7] Muestra las camisetas de x7.
//              0.14 [!camisetasselec] Muestra las camisetas de las selecciones.
...
//      Changelog:
//          0.1 08/06/2023:
//              0.1 Se arreglo el error de que si le pegabas a la pelota y no la tocabas no te contaba el toque.
//              0.2 Ahora las recs estaran separadas por modalidad (x3, x4, x7).
//              0.3 Se aumento la capacidad del host.
//              0.4 Se actualizaron las camisetas:
//                  0.1 Se eliminaron:
//                      0.1 bjp (Banana juniors plate)
//                      0.2 rkf (Riki Forever)
//                      0.3 afc (Atlantis FC)
//                      0.4 gx (G3neration X)
//                  0.2 Se agregaron: 
//                      0.1 nt (North Texas Brasil)     
//                      0.2 rz (Razer)  
//                      0.3 SyG (Steal Your Glory)
//                      0.4 bb (Brampton Beast)             
//              0.5 Se cambio el comando [!setcamiseta] por: [![ID]2|3 red|blue] mas info de su uso en discord.
//
// ------------------------------------------------
...
const camisetasx4 = [
    ...
    {id: "drs", nombre: "Dark Silence FC", uniform: [{ angle: 50, mainColor: [0xB30202, 0x000000, 0xB30202], avatarColor: 0xFFFFFF }, { angle: 50, mainColor: [0x000000, 0xFF0000, 0x000000], avatarColor: 0xFFFFFF }]},
    ...
    {id: "idd", nombre: "Inter de Denver", uniform: [{ angle: 0, mainColor: [0x0F0F0F, 0xD6B138], avatarColor: 0xFFFFFF }, { angle: 60, mainColor: [0x23A1ED], avatarColor: 0xFFFFFF }]},
    ...
    {id: "dd", nombre: "Deportivo de Denver", uniform: [{ angle: 30, mainColor: [0x0F0F0F, 0x0F0F0F, 0xD6B138], avatarColor: 0xFFFFFF }, { angle: 35, mainColor: [0x333433, 0x5A6873, 0x333433], avatarColor: 0xFBDA4B }, {angle: 60, mainColor: [0x008C7E], avatarColor: 0x0D0D0D}]},
    {id: "mdq", nombre: "Mar del Plata FC", uniform: [{ angle: 60, mainColor: [0xEDA3FF, 0x000000], avatarColor: 0xFFFFFF }, { angle: 60, mainColor: [0x000000, 0x004077, 0x000000], avatarColor: 0xFFFFFF }, {angle: 60, mainColor: [0x82FF8F], avatarColor: 0x000000}]},
...
const camisetasx3 = [
    {id: "rn", nombre: "Rio Negro", uniform: [{ angle: 40, mainColor: [0x000000], avatarColor: 0x949494 }, { angle: 40, mainColor: [0xFFFFFF], avatarColor: 0x000000 }, { angle: 0, mainColor: [0x404040, 0x000000, 0x404040], avatarColor: 0xFFFFFF }]},
    {id: "bm", nombre: "Bayern Munich", uniform: [{ angle: 60, mainColor: [0xA30303, 0x820000, 0x630000], avatarColor: 0xFFFFFF }, { angle: 60, mainColor: [0x000000, 0x000000, 0x171717], avatarColor: 0xD1B500 }, { angle: 60, mainColor: [0xFFFFFF], avatarColor: 0x8F0101 }]},
    ...
    {id: "sm", nombre: "Seattle Mariners", uniform: [{ angle: 60, mainColor: [0x9CFCFF], avatarColor: 0x003331 }, { angle: 0, mainColor: [0x00E5FF, 0x78F6FF, 0x00E5FF], avatarColor: 0x000000 }, { angle: 0, mainColor: [0x093336, 0x093336, 0x9CFCFF], avatarColor: 0x000000 }]},
    {id: "oym", nombre: "Origami y Mascarillas", uniform: [{ angle: 60, mainColor: [0x000000], avatarColor: 0xFFFF00 }, { angle: 60, mainColor: [0x000000, 0xFF0000, 0xFF0000], avatarColor: 0xFFFFFF }, {angle: 60, mainColor: [0x949494], avatarColor: 0x000000}]},
    {id: "col", nombre: "Colon", uniform: [{ angle: 0, mainColor: [0xFF0000, 0x000000], avatarColor: 0xFFFFFF }, { angle: 60, mainColor: [0x000000, 0x0A0A0A, 0x0F0F0F], avatarColor: 0xE6D87E }, {angle: 90, mainColor: [0x4F4F38, 0x4F0000, 0x4F4F38], avatarColor: 0x000000}]},
    {id: "wv", nombre: "Wolverhampton", uniform: [{ angle: 0, mainColor: [0xFFD500], avatarColor: 0x000000 }, { angle: 35, mainColor: [0x333433, 0x5A6873, 0x333433], avatarColor: 0xFBDA4B }, {angle: 60, mainColor: [0x008C7E], avatarColor: 0x0D0D0D}]},
    {id: "rh", nombre: "Robin Hood", uniform: [{ angle: 90, mainColor: [0xFF2424, 0x198A1D], avatarColor: 0x000000 }, { angle: 90, mainColor: [0x630E0E], avatarColor: 0x12570E }, { angle: 90, mainColor: [0x146311], avatarColor: 0x570000 }]},
    {id: "mg", nombre: "Macarena Gang", uniform: [{ angle: 60, mainColor: [0xFFD712, 0x198A1D, 0x198A1D], avatarColor: 0x000000 }, { angle: 90, mainColor: [0x4D1063], avatarColor: 0x000000 }, { angle: 60, mainColor: [0xE48AFF, 0x810A8A, 0xE48AFF], avatarColor: 0x000000 }]},
    {id: "afc", nombre: "Atlantis FC", uniform: [{ angle: 0, mainColor: [0xAB1019, 0xB8111B, 0x450308], avatarColor: 0x160117 }, { angle: 90, mainColor: [0x002033, 0x002D54, 0x003C5E], avatarColor: 0x03D5FF }, { angle: 47, mainColor: [0x242259, 0x000103, 0x1E1940], avatarColor: 0x917E74 }]},
    {id: "psg", nombre: "Porteñitas Saint Germain ", uniform: [{ angle: 60, mainColor: [0x00074A], avatarColor: 0x757575 }, { angle: 0, mainColor: [0x00074A, 0x7D0000, 0x00074A], avatarColor: 0xFFFFFF }, { angle: 0, mainColor: [0xFFFFFF], avatarColor: 0x961717 }]},
    {id: "sod", nombre: "Sold Out Dates", uniform: [{ angle: 60, mainColor: [0x053187], avatarColor: 0xFFFFFF }, { angle: 0, mainColor: [0x73FFFF, 0x377991, 0x73FFFF], avatarColor: 0x000000 }, {angle: 60, mainColor: [0x000880, 0x0404C2, 0x000000], avatarColor: 0x1A12F}]},
    {id: "yM", nombre: "Young Macarena", uniform: [{ angle: 62, mainColor: [0xFFFF66, 0x37FF29], avatarColor: 0x0F0F0F }, { angle: 62, mainColor: [0x520606, 0x000000], avatarColor: 0xFFF673 }]},
    {id: "ajx", nombre: "Ajax", uniform: [{ angle: 0, mainColor: [0xFFFFFF, 0xFF000, 0xFFFFFF], avatarColor: 0xFFFFFF }, { angle: 0, mainColor: [0x020C4D], avatarColor: 0xE9F728 }]},
    {id: "nt", nombre: "North Texas Brasil", uniform: [{ angle: 220, mainColor: [0xF8DD2E], avatarColor: 0x038434 }, { angle: 220, mainColor: [0x0007EB, 0x0022FF, 0x0022FF], avatarColor: 0xF8DD2E}]}
]
...
var discordWebhookFirmas = 'https://discord.com/api/webhooks/1095756756283555900/PCIgkKQGiTe6fifXQ3jy2N5pAqUW2E5C1xXgLtLyHbMIT9dLTkD7VyWl4qWRh2K7CUqY'
var gameWebhook = ['https://discord.com/api/webhooks/1099731795626438767/8FB3LdW_VWwAEayAQ60JAPw7mtxkx203QTJQVfYur0mQ32_SwWgYxWPYHscefmU3-bS2', 'https://discord.com/api/webhooks/1117170803407069336/q4zK_ZbUp0FMZER8_3pcFL8uVOnRKcrMcyoLt-eAzzUWhOuThDnuspQfvtEuzwnmo96N', "https://discord.com/api/webhooks/1117170992511467561/NrbBdNqi_Og1nC3Vcq8sGc1hFwmFIUJicmwj5dGcght22-qDFjXZ3XQFU1rxpdeusbSS"]
var firmas = [];
var authArray = [];
var players = [];
var teamRed = [];
...
room.onPlayerChat = function (player, message) {
    if (message.startsWith("!")) {
        ...
        if (args[0] == "admin" && args.length == 1) {
            ...
            announce("Comandos disponibles: !help, !bb, !nv, !admin, !liga, t [msg], @@[Jugador] [msg]", player.id, null, "small", 2)
            if (player.admin) { 
                announce("Comandos de Admin: !rr, !swap, !clearbans, !oficial, !x3, !x4, !x7, !fah, !setpassword, !clearpassword, !camisetasx4 .", player.id, 0xffff00, "small")
            ...
            announce("Discord de ACF: https://discord.gg/JzCH2BnGHn", player.id, null, null, 2)
        }
           ...
           if (oficialMode == true) { 
            ...
            if (player.admin) {
                room.stopGame();
                room.setCustomStadium(fah);
                room.startGame();
                mapSelect = 0;
                announce(`[✅] ${player.name}, cambió el mapa a "Futsal X4 by FAH"`, null, 0x00ff00, "bold", 2)
            }
            else {
                announce("[✖] No tienes permiso para ejecutar este comando.", player.id, 0xff0000, "bold", 2)
            }
        ...
        else if (args[0] == "camisetasx3") {
            if (player.admin) {
                var camisetas = [];
                for (i = 0; i < camisetasx3.length; i++) {
                    if (i != 0) {                    
                        camisetas.push(` ${camisetasx3[i].nombre}: ${camisetasx3[i].id}`)
                    }    
                    else {
                        camisetas.push(`${camisetasx3[i].nombre}: ${camisetasx3[i].id}`)
                    }
